...
public class StudentController {
	 ...
	 * 
	 * 사용하기 번거롭고
	 * final 이 아니라 변경 당할수도 있어용
	 * 
	 * 보통 @Autowired 를 사용한 Setter 주입방식을 사용하는데
	 * Setter 주입 방식에서는 메모리 릭(leak, 누수)가 발생하기도 한다
	...
	// localhost:8080/school/student/ 둘다가능
	...
	/*
	 * form 에서 input 담긴 데이터를 수신하는 method
	 */
	...
	public String input(String st_num, String st_name, 
			String st_dept, int st_grade, String st_tel, String st_addr) {
