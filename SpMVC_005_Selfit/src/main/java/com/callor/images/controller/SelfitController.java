...
public class SelfitController {
	...
	public SelfitController(@Qualifier(QualifierConfig.SERVICE.SELFIT_V2) SelfitService selfitService) {
	...
	public String daySet(@PathVariable("sc_num") String sc_num, @PathVariable("sc_id") String sc_id , Model model) {
	...
	public String dayHealth(@PathVariable("list_id") String listid, @PathVariable("sc_id") String sc_id, Model model) {
