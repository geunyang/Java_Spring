...
<style>
	...
	#begin-box:checked ~ .begin-box, 
	#middle-box:checked ~ .middle-box, 
...
<body>
	...
	<ol class="begin-list">
		<li><a href="#">주당 운동 3일 루틴</a></li>
		<li><a href="#">주당 운동 4일 루틴</a></li>
		<li><a href="#">주당 운동 5일 루틴</a></li>
		<li><a href="#">주당 운동 6일 루틴</a></li>
	</ol>
	<ol class="middle-list">
		<li><a href="#">일주일 운동 3일 루틴</a></li>
		<li><a href="#">일주일 운동 4일 루틴</a></li>
		<li><a href="#">일주일 운동 5일 루틴</a></li>
		<li><a href="#">일주일 운동 6일 루틴</a></li>
	</ol>
	<ol class="adv-list">
		<li><a href="#">주 운동 4일 루틴</a></li>
