...
public class MemoController {
	...
	/*
	 * multipart/form-data를 선언, 입력된 값을 
	 * MemoDTO 로 받는다
	 * MultipartResolver 설정해야 입력된 값 받을 수 있음
	 * 
	 * 중요!!!!
	 * 첨부파일이 있는 프로젝트에서 
	 * form 의 file input box의 이름은 절대 VO(DTO) 클래스에 선언된 이름을 사용하면 안된다 
	 */
	...
	public String insert(
		...
		// 메모 저장 전 현재 session 에 저장된 username 가져오기
		String username = (String) httpSession.getAttribute("USERNAME");
	...
	public String update(@PathVariable("seq") String seq, @ModelAttribute("memo") MemoDTO memoDTO, MultipartFile file,
		...
		// 로그인 된 사용자의 이름을 memoDTO 에 setting 하기
