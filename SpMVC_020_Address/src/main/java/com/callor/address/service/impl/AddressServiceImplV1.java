...
public class AddressServiceImplV1 implements AddressService{
	 ...
	 * ServiceImpl 클래스에서 Dao 를 생성자로 주입 받을때
	 * 생성자에서 오류가 발생하는 경우가 있다 ... circular: 무한 반복 주입 오류, 순환 참조 오류
	...
	/*
	 * 이 method 에서 dao 의 create_addr_table() method 를 호출하여 table 을 생성할수 있으나
	 * dao 같은 이름의 method 를 호출하면 circular reference 오류가 발생하는 경우가 있다
	 * 때문에 이 method 를 사용하지 않고 별도의 method 를 만들어 사용
	 */
	@Override
