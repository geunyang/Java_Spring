...
<sec:authorize access="isAuthenticated()">
	...
	<c:forEach items="${TODOS}" var="TODO">
		<div data-seq="${TODO.t_seq}" title="등록일 : ${TODO.t_sdate},${TODO.t_stime}" class="todo_content w3-border w3-padding-16 w3-margin w3-tooltip">
		<span data-seq="${TODO.t_seq}" class="todo_content w3-text">${TODO.t_sdate} ${TODO.t_stime}</span>${TODO.t_content}</div>
	</c:forEach>
	<form:form>
		<input name="t_content" value="${TODO.t_content}" placeholder="TODO INSERT" class="w3-input w3-border"/>
	</form:form>
</sec:authorize>
</div>