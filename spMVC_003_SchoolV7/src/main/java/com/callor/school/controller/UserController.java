...
public class UserController {
	 ...
	 * 	만약 정상적인 사용자가 아니면 null 을 담아서 return
	 * 6. Controller.login.POST method 에는 HttpSession 클래스를 매개변수로 설정한다
	 * 7. 정상 사용자 정보이면(userVO 가 null 이 아니면)
	 * 	setAttribute() method 를 사용하여 사용자 정보를 변수에 setting한다
	 * 8. 정상 사용자가 아니면 removeAttibute() method 를 사용하여 변수를 제거해버린다
	 */
	...
	/*
	 *  username 중복 검사를 하기 위하여 보통 다음과 같은 요청을 수행한다
	 *  /user/idcheck?usercame=callor
	 *  
